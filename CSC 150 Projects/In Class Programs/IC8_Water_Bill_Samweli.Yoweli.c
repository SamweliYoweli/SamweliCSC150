...
/* Computes and prints a water bill given an unpaid balance and previous
and current meter readings. Bill includes a demand charge of $35.00, a use
Charge of $1.10 per thousand gallons, and a surcharge of $2.00
...
/* ---- Preprocessor Directives ---- */
    ...
    /* ---- Constant macro definitions ---- */
        ...
        #define OVERUSE_CHG_RATE 2.0 /* double use charger as conservation penalty */

        #define CONSERV_RATE 95 /* Conservation rate*/
...
double late_charge; /* charge for nonpayment of part of
 previous balance */
...
/* Get data: unpaid balance, previous and current
meter readings. */
...
printf("Enter last year's quarter's usage> ");
...
printf("and previous quarter usage");
...
/* Computers use charge with conservation requirements,
...
double comp_use_charge(int previous, int current, int use_last_year)
{
  ...
  if(used <= CONSERV_RATE/110.0 * use_last_year) {
...
/* Computes late charge. Pre : unpaid is defined */
